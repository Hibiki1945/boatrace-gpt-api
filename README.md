...
- 今期と直近6ヶ月の成績比較、F持ち、決まり手、逃げシミュレーション（2着・3着・出目）、評価コメントを返す
- 表形式とBOATCAST系の貼り付け形式を判定して展示情報を読む。欠けた任意表は警告に留め、展示評価を止めない
- Claude画面のUIは移植せず、GPT Actionで使う計算結果・根拠・注意・コメントをJSONで返す
